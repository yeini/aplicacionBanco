        ...
        <div class="sign">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="group"> 
                    ...
                    <input id="name" type="text" class="input @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}"   autofocus>
                    @error('name')
                ...
                <div class="group"> 
                    ...
                    <input id="identificacion" type="number" class="input @error('identificacion') is-invalid @enderror" name="identificacion" value="{{ old('identificacion') }}" >
                ...
                <div class="group"> 
                    ...
                    <input id="email" type="email" class="input @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"  >
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <small>{{ $message }}</small>
                        </span>
                ...
                <div class="group"> <input type="submit" class="button" value="Aceptar">
                    <div class="hr"></div> 
                    <div class="foot"> <a href="{{ url('/') }}"> ¿Ya eres miembro? Ingresa aquí.</a> </div>
                </div>
            </form>
        </div>
    </div>
