                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('transaccion.store')}}" method="post" class="form-horizontal">
                               ...
                               <input type="hidden" id="tipo" name="tipo" value="1"> 
                                ...
                                <input class="form-control @error('montodeposito') is-invalid @enderror" type="number" name="montodeposito" placeholder="Ingrese el valor a Depositar" id="montodeposito">
                                @error('montodeposito')
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('transaccion.store')}}" method="post" class="form-horizontal">
                               ...
                               <input type="hidden" id="tipo" name="tipo" value="2">
                                ...
                                <input class="form-control @error('montoretiro') is-invalid @enderror" type="number" name="montoretiro" placeholder="Ingrese el valor a Retirar" id="montoretiro">
                                @error('montoretiro')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="card-body"><br>
                            ...
                            <form action="{{route('transaccion.store')}}" method="post" class="form-horizontal">
                               ...
                               <input type="hidden" id="tipo" name="tipo" value="3">
                                ...
                                <input class="form-control @error('cuenta_destino') is-invalid @enderror" type="text" name="cuenta_destino" placeholder="Ingrese el Número de Cuenta" id="cuenta_destino">
                                @error('cuenta_destino')
                                    <span class="invalid-feedback" role="alert">
                                        <small>Ingrese el # de cuenta.</small>
                                    </span>
                                @enderror
                                <br>
                                <input class="form-control @error('montotransaccion') is-invalid @enderror" type="number" name="montotransaccion" placeholder="Ingrese el valor a Depositar" id="montotransaccion">
